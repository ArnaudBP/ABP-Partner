...
export default function AvisSection({
  ...
  const displayTitle = title || "Ce que mes";
  const displayHighlight = titleHighlight || "Clients disent";
  const displayDescription = description || "Découvrez les témoignages de mes clients satisfaits sur Houzz.";
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-shrink-0 text-center md:text-left">
              ...
              <h3 className="text-2xl font-bold text-gray-900">{displayTitle} <span className="text-abp-gold">{displayHighlight}</span></h3>
              <p className="text-gray-500 text-sm">{displayDescription}</p>
            </div>
